...
The following table shows the verification status of each invariant using [Echidna](https://github.com/crytic/echidna)/[hevm](https://github.com/ethereum/hevm/) and the [Certora Prover](https://www.certora.com/):
