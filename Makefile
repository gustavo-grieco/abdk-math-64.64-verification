...
verify-hevm:
	...
	hevm test --max-buf-size 12 --debug --loop-detection-heuristic StackBased --max-iterations 65 --max-depth 70 --smttimeout 300 --solver bitwuzla $(HEVM_ARG) | tee logs/verify-hevm.log
